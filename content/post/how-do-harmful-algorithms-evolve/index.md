...
Apart from the research and results shared in the book the author tries to provide his own vision for a better world with better sleep for more people as he believes it improves lots of aspects including health, education, and even GDP *(which is one of the unconvincing correlations in the book)* !

let me share a couple of quotes  about specific points that bugged me:
...
This was one of the most troubling parts to me, coming from someone with a scientific background. It seemed like statements that were written only for the sake of supporting the narrative of the book which linked EVERYTHING to sleep. I even looked up the mentioned reference *[Social loafing under fatigue]*, and I wasn't convinced that it could be used as a resource to reach a broad statement like *“Ethical deviance linked to a lack of sleep also weasels its way onto the work stage in a different guise, called social loafing”*. Especially if you know that this statement was based on the results from a study where *“2 experiments, 64 male students worked almost continuously for 20 hr without sleep under varying social conditions”*. 
...
- The ideas and theories present a potential profitable business opportunity, and in a time where the hype about data, AI, wearables is at its peak, someone will pick these ideas and take them forward, mostly with no inherent bad intentions.


## And why such products grow and get worse?

So following  this path, it ends up with  an enthusiastic product team in an established company or most probably a startup, who get fascinated by the ideas of the author which were backed by “science” as they saw it. They will start to transform it into products, pitch it to investors, get busy working on the codebase and the powering algorithm, etc. Now they are the accountable ones, not the originator of the idea, but I wonder how many would ask questions like:
...
- What if employers took this ethical-performance correlation as a scientific fact and started to penalize new parents, sick, etc.? Is it something we would like to see happening?!


These and many other questions are rarely asked, because founders think that they need to move fast, work on their data pipelines, mange their finances, hire, etc. On the other hand investors want to push for growth and mostly care about the revenue. That's why these questions get lost and we face them as users or data practitioners after being impacted by the product that we didn't sign up for in the first place,especially  if it gets used by entities that has power over us *(e.g government, employer, etc.)*.
