...
Suppose that you wanted to define a variable facet, you wouldn't have this flexibility even with `aes_string`. But now you can have it as in the following example. Notice that `vars()` is a new helper instead of `~`
