...
You can even use the dots `...` to have more flexibility and allow the function to take more than one variable for faceting. Here you will need to use `quos()` to capture the dots and pass the result directlt to the facet layer `facet_wrap` as follows.
