---
date: 2017-08-12
title: My First Steps into The World of Tidyeval
subtitle: "Bang Bang!!"
tags: [R, Tidyeval]
---
...
What led me to Tidyeval was the the desire to prgram around dplyr. The example I shared in the issue was having a list column `Tags_terms` in a dataframe `dat_r`, that I wanted to mutate with the count of tags in each row. Pretty simple!
...
**So those were my first steps in the world of the Tidyeval. I like how it gives me more control and flexibility, yet I am still learning and grasping its capabilities. I am not sure if all what I am doing adheres to the best practices, so I'll keep learning about it. And I'd be grateful to receive any feedback regarding the use cases I showed and better ways to handle them** 
