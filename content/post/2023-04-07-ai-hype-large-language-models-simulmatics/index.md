---
title: 'AI Hype-Driven Development - Parallels in History'
subtitle: 'Recurring Patterns from Simulmatics to the Large Language Models Hype'
date: '2023-04-07'
...
<p align='right'> 
Jill Lepore </br>
<a href="https://scholar.harvard.edu/jlepore/publications/if-then-how-simulmatics-corporation-invented-future">IF THEN: How the Simulmatics Corporation Invented the Future</a>
</p>
</blockquote>
...
- training data contamination as explained by [Arvind Narayanan](https://substack.com/profile/19265909-arvind-narayanan) and [Sayash Kapoor](https://substack.com/profile/891603-sayash-kapoor) in their article [GPT-4 and professional benchmarks: the wrong answer to the wrong question](https://aisnakeoil.substack.com/p/gpt-4-and-professional-benchmarks). 

- lack of valid and rigorous evaluation methodologies as highlighted by [Melanie Mitchell](https://www.santafe.edu/people/profile/melanie-mitchell) in her posts [Did ChatGPT Really Pass Graduate-Level Exams?](https://aiguide.substack.com/p/did-chatgpt-really-pass-graduate-baa)
...
For instance, when Meta’s [Galactica](https://www.technologyreview.com/2022/11/18/1063487/meta-large-language-model-ai-only-survived-three-days-gpt-3-science/) was criticized and pulled back, [Yann Lecun](http://yann.lecun.com/) stated that the developers took it back to *“protect their own mental well-being”*[*](https://twitter.com/ylecun/status/1594377947401818113) because they were *"distraught by the vitriol on Twitter”*. He saw the public criticism as an attack that impeded progress!
...
<img src="images/pool.png" alt="" width="65%"/>

<center><i>An MIT Students for a Democratic Society (SDS) poster, c. 1971. [^1]</i> </center>

Nowadays, we know that tech companies also run after military and government contracts. In some cases the employees know and protest and in other cases such contracts are hidden. For instance, we recall the pushback against [Project Maven](https://www.nytimes.com/2018/06/01/technology/google-pentagon-project-maven.html), and now the [No Tech For Apartheid](https://www.notechforapartheid.com/) call against [Project Nimbus](https://www.theguardian.com/commentisfree/2021/oct/12/google-amazon-workers-condemn-project-nimbus-israeli-military-contract). 
